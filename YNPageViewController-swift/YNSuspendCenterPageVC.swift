...
class YNSuspendCenterPageVC: BasePageViewController {
...
extension YNSuspendCenterPageVC: YNPageViewControllerDelegate, YNPageViewControllerDataSource {
